...
@section('content')
	...
	<form action="{{ URL::route('admin.pages.edit-post', $page->id) }}" method="post">
		...
		<div class="form-group">
			...
			<textarea name="content" rows="8" placeholder="Введите описание товара" id="content" class="form-control wysiwyg">{{ (Input::old('content')) ? e(Input::old('content')) : $page->content }}</textarea>
