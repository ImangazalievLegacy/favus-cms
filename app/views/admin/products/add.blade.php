...
@section('content')
	...
	<form action="{{ URL::route('admin.products.add-post') }}" method="post" class="add-product">
		...
		<div class="form-group">
			...
			<textarea name="description" rows="8" placeholder="Введите описание товара" id="description" class="form-control">{{ (Input::old('description')) ? e(Input::old('description')) : '' }}</textarea>
